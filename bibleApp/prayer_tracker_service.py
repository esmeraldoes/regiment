...
#     def StartPrayer(self, request, context):
#         user_id = request.user_id
#         self.prayer_times[user_id] = time.time()
#         response = pb2.PrayerResponse(message="Prayer started.")
#         return response
...
#         user_id = request.user_id
#         if user_id in self.prayer_times:
#             start_time = self.prayer_times[user_id]
#             prayer_duration = int(time.time() - start_time)
#             del self.prayer_times[user_id]
#             response = pb2.PrayerResponse(message=f"Prayer ended. Duration: {prayer_duration} seconds.")
#         else:
#             response = pb2.PrayerResponse(message="No active prayer session found.")
#         return response
...
# class PrayerTrackerService(pb2_grpc.PrayerTrackerServiceServicer):
#     def __init__(self):
#         self.prayer_times = {}
